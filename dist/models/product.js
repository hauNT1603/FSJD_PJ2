...
var Products = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not find product ".concat(id, ". ").concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    Products.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, rows, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        connection = _a.sent();
                        sql = "INSERT INTO products (name, price,description) VALUES($1, $2, $3) RETURNING *";
                        return [4 /*yield*/, connection.query(sql, [
                                product.name,
                                product.price,
                                product.description,
    ...
    Products.prototype.update = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, rows, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        connection = _a.sent();
                        sql = "UPDATE products SET name = $2, price = $3, description = $4 WHERE id = $1 RETURNING *";
                        return [4 /*yield*/, connection.query(sql, [
                                p.id,
                                p.name,
                                p.price,
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not update product ".concat(p.id, ". Error: ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    Products.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, rows, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
